...
<AccordionGroup>
  ...
  <Accordion title="429 Too Many Requests">
    **What it means:** the business has hit its monthly task quota (15 on the free tier, higher if you've arranged it).

    The response body tells you how many you've used and the current cap:
    ...
    **What to do:**
    ...
    - Or email [team@stablebrowse.ai](mailto:team@stablebrowse.ai) to have your limit raised.

    See [Authentication → Rate limits](/authentication#rate-limits) for details.
  </Accordion>
