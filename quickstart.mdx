...
Sign in to the [dashboard](https://main.dxljyf58fkcrt.amplifyapp.com) and go to **Settings → API Keys → Create API key**. Copy the `sb_live_...` value shown in the banner — **it's displayed exactly once**. Lose it and you'll need to mint a new one.
