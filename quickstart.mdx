...
Sign in to the [dashboard](https://main.d3qu1deiqzszds.amplifyapp.com) and go to **Settings → API Keys → Create API key**. Copy the `sb_live_...` value shown in the banner — **it's displayed exactly once**. Lose it and you'll need to mint a new one.
...
If you need data from Twitter, Reddit, TikTok, or Instagram behind a login, upload your end-user's cookies first:
