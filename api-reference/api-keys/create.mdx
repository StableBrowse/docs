...
<Warning>
  This endpoint requires a Cognito JWT from the [dashboard](https://main.d3qu1deiqzszds.amplifyapp.com). API-key bearer tokens are **refused** (403) by design — a leaked key can't entrench itself by creating more keys.
