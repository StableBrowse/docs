...
Keys are minted in the [dashboard](https://main.d3qu1deiqzszds.amplifyapp.com) under **Settings → API Keys**. See [Authentication](/authentication) for rotation and revocation.
...
<CardGroup cols={2}>
  ...
  <Card title="Create API key" icon="key" href="/api-reference/api-keys/create">
    `POST /v1/api-keys`
  </Card>
  <Card title="List API keys" icon="list-check" href="/api-reference/api-keys/list">
    `GET /v1/api-keys`
  </Card>
  <Card title="Revoke API key" icon="ban" href="/api-reference/api-keys/revoke">
