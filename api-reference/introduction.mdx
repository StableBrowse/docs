...
Keys are minted in the [dashboard](https://main.dxljyf58fkcrt.amplifyapp.com) under **Settings → API Keys**. See [Authentication](/authentication) for rotation and revocation.
